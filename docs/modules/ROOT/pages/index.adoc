...
link:https://metallb.universe.tf/[MetalLB] works with the xref:it::network.adoc[Router] via BGP to provide Adresses from the 192.168.8.32/27 range to the cluster.
